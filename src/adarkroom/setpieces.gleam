...
fn outpost() -> Event {
  Event(
    audio: Some(audio.landmark_friendly_outpost),
    title: "An Outpost",
    is_available: always,
    scenes: [
      #(
...
fn swamp() -> Event {
  Event(
    audio: Some(audio.landmark_swamp),
    title: "A Murky Swamp",
    is_available: always,
    scenes: [
      #(
...
fn battlefield() -> Event {
  Event(
    audio: Some(audio.landmark_battlefield),
...
fn borehole() -> Event {
  Event(
    audio: Some(audio.landmark_borehole),
...
fn cave() -> Event {
  ...
  Event(
    audio: Some(audio.landmark_cave),
    title: "A Damp Cave",
    is_available: always,
    scenes: [
      #(
...
fn town() -> Event {
  ...
  Event(
    audio: Some(audio.landmark_town),
...
fn ship() -> Event {
  Event(
    audio: Some(audio.landmark_crashed_ship),
...
fn house() -> Event {
  Event(
    audio: Some(audio.landmark_house),
    title: "An Old House",
    is_available: always,
    scenes: [
      #(
...
fn sulphurmine() -> Event {
  ...
  Event(
    audio: Some(audio.landmark_sulphur_mine),
...
fn coalmine() -> Event {
  ...
  Event(
    audio: Some(audio.landmark_coal_mine),
    title: "The Coal Mine",
    is_available: always,
    scenes: [
      #(
...
fn ironmine() -> Event {
  Event(
    audio: Some(audio.landmark_iron_mine),
    title: "The Iron Mine",
    is_available: always,
    scenes: [
      #(
...
fn city() -> Event {
  Event(
    audio: Some(audio.landmark_city),
    title: "A Ruined City",
    is_available: always,
    scenes: [
      #(
      ...
      #(
        ...
        Scene(
          ...
          buttons: [
            #(
              "continue",
              branch("continue", [#(0.5, "end10"), #(1.0, "end11")]),
            ),
            #("leave", leave("leave city")),
          ],
        ),
...
fn cache() -> Event {
  Event(
    audio: Some(audio.landmark_destroyed_village),
